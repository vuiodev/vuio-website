  ...
  const downloads = [
    {
      ...
      builds: [
        { arch: 'x86_64', size: '2.7 MB', downloadUrl: 'https://github.com/vuiodev/vuio/releases/download/v0.0.38/vuio-windows-x86_64.exe' },
        { arch: 'ARM64', size: '2.6 MB', downloadUrl: 'https://github.com/vuiodev/vuio/releases/download/v0.0.38/vuio-windows-arm64.exe' }
      ]
    },
    {
      platform: 'macOS',
      ...
      builds: [
        { arch: 'Intel', size: '2.5 MB', downloadUrl: 'https://github.com/vuiodev/vuio/releases/download/v0.0.38/vuio-macos-x86_64.tar.gz' },
        { arch: 'Apple Silicon', size: '2.5 MB', downloadUrl: 'https://github.com/vuiodev/vuio/releases/download/v0.0.38/vuio-macos-arm64.tar.gz' }
      ]
    },
    {
      platform: 'Linux',
      ...
      builds: [
        { arch: 'x86_64', size: '4.8 MB', downloadUrl: 'https://github.com/vuiodev/vuio/releases/download/v0.0.38/vuio-linux-x86_64.tar.gz' },
        { arch: 'ARM64', size: '5 MB', downloadUrl: 'https://github.com/vuiodev/vuio/releases/download/v0.0.38/vuio-linux-arm64.tar.gz' },
        { arch: 'ARMv7', size: '5 MB', downloadUrl: 'https://github.com/vuiodev/vuio/releases/download/v0.0.38/vuio-linux-armv7.tar.gz' }
      ]
    },
    {
      platform: 'Docker',
